...
#include "server/zone/objects/creature/commands/Saber1hBleedCommand.h"
...
#include "server/zone/objects/creature/commands/Saber2hPowerAttackCommand.h"
...
#include "server/zone/objects/creature/commands/SaberArmorBreakCommand.h"
#include "server/zone/objects/creature/commands/SaberBlockCommand.h"
#include "server/zone/objects/creature/commands/SaberIntimidatingStrikeCommand.h"
...
#include "server/zone/objects/creature/commands/SaberPolearmLowBlowCommand.h"
...
#include "server/zone/objects/creature/commands/SerenityCommand.h"
...
void CommandConfigManager::registerCommands3() {
	...
	commandFactory.registerCommand<Saber2hPowerAttackCommand>(String("saber2hPowerAttack").toLowerCase());
	...
	commandFactory.registerCommand<SaberBlockCommand>(String("saberBlock").toLowerCase());
	commandFactory.registerCommand<SaberIntimidatingStrikeCommand>(String("saberIntimidatingStrike").toLowerCase());
	...
	commandFactory.registerCommand<SaberPolearmLowBlowCommand>(String("SaberPolearmLowBlow").toLowerCase());
	...
	commandFactory.registerCommand<SerenityCommand>(String("serenity").toLowerCase());
