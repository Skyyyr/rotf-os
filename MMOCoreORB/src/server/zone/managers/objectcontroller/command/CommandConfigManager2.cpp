...
#include "server/zone/objects/creature/commands/ArmorBreakCommand.h"
...
#include "server/zone/objects/creature/commands/ForceInfusionCommand.h"
...
#include "server/zone/objects/creature/commands/ForceLightningCone4Command.h"
#include "server/zone/objects/creature/commands/ForceLightningCone5Command.h"
...
#include "server/zone/objects/creature/commands/ForceLightningSingle4Command.h"
#include "server/zone/objects/creature/commands/ForceLightningSingle5Command.h"
...
#include "server/zone/objects/creature/commands/ForceThrow3Command.h"
...
void CommandConfigManager::registerCommands2() {
	...
	commandFactory.registerCommand<ForceLightningCone4Command>(String("forceLightningCone4").toLowerCase());
	commandFactory.registerCommand<ForceLightningCone5Command>(String("forceLightningCone5").toLowerCase());
	...
	commandFactory.registerCommand<ForceLightningSingle4Command>(String("forceLightningSingle4").toLowerCase());
	commandFactory.registerCommand<ForceLightningSingle5Command>(String("forceLightningSingle5").toLowerCase());
	...
	commandFactory.registerCommand<ForceThrow3Command>(String("forceThrow3").toLowerCase());
